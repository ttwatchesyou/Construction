...
const PageContent = styled(Content)`padding:24px;overflow:auto;@media(min-width:768px){&>.ant-row:first-child>.ant-col{flex:0 0 25%;max-width:25%;}}@media(max-width:1200px){padding:18px;}@media(max-width:767px){padding:12px;&>.ant-row:first-child>.ant-col{flex:0 0 50%;max-width:50%;}}`;
...
const BarLabel = styled.div`display:flex;justify-content:space-between;gap:8px;color:#94a3b8;font-size:10px;margin-top:9px;span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;}`;
